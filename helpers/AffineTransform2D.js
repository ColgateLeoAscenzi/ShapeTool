...
AffineTransform2D.prototype.rotateAbout = function(
                            /* Number */ x, /* Number */ y,  /* Number */ degrees ) {
   // FILL IN
   this.translate(x,y);
   this.rotate(degrees);
   this.translate(-x,-y);
...
AffineTransform2D.prototype.scaleAbout = function(
                       /* Number */ x, /* Number */ y, /* Number */ sx, /* optional Number */ sy) {
